---
description: >-
  Ansible role specialist for writing, reviewing, and refactoring tasks,
  handlers, templates, variables, defaults, and meta files. Manages the Check
  Point WAF agent and Docker installation role following Ansible best practices.
mode: subagent
